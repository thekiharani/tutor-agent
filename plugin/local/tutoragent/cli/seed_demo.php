<?php
// One course, six activities, one extra site admin and ten students enrolled in
// it, all sharing DEMO_PASSWORD. `make rehearse` passes --reset-blank to clear
// every student.blank* account for another run.
//
// The course is a projection of recommender/data/intents.json: its six
// activities are the six topics that file holds, and nothing is seeded that the
// content library cannot answer for.
